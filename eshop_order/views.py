...
class CartView(View):
	def get(self, request):
		cart = Cart(request)
		return render(request, 'eshop_order/cart.html', {'cart':cart})
...
class CartAddView(PermissionRequiredMixin, View):
	...
	def post(self, request, product_id):
		...
		return redirect('eshop_order:cart')
...
class OrderDetailView(LoginRequiredMixin, View):
	...
	def get(self, request, order_id):
		...
		return render(request, 'eshop_order/order.html', {'order':order, 'form':self.form_class})
	...
	def post(self, request, order_id):
		...
		if form.is_valid():
			...
			try:
				...
				return redirect('eshop_order:order_detail', order_id)
			order = Order.objects.get(id=order_id)
